...
import {
  ...
  FileEdit, Clock, Info, FilePlus, Activity, Hexagon, Wifi,
} from "lucide-react";
...
const HTTPPlaygroundTool = lazy(() => import("@/components/tools/HTTPPlaygroundTool").then(m => ({ default: m.HTTPPlaygroundTool })));
const HexScopeTool = lazy(() => import("@/components/tools/HexScopeTool").then(m => ({ default: m.HexScopeTool })));

export type ToolId = "json" | "image" | "jwt" | "api" | "encoder" | "text-compare" | "log-parser" | "random-generator" | "data-converter" | "ip-lookup" | "js-editor" | "data-viz" | "bg-remover" | "search" | "topology-viewer" | "pdf-editor" | "pdf-generator" | "cron-generator" | "regex-explainer" | "traffic-simulator" | "hexscope" | "http-playground";
...
const tools: Tool[] = [
  ...
  { id: "http-playground", label: "HTTP Playground", icon: Wifi, component: HTTPPlaygroundTool },
