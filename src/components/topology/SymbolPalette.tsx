...
import { Database, HardDrive, Cpu, Zap, Shield, Network, Server, Layers, Box, MessageSquare, Container, Cloud, CloudCog, CloudRain, Circle, ChevronDown, Workflow, Search, BarChart3, Flame, Binary, Type, GalleryVerticalEnd, Router, ArrowLeftRight, GitBranch, ServerCog, Globe } from 'lucide-react';
...
const baseSymbols: Symbol[] = [
  ...
  { type: 'dns', label: 'DNS Server', icon: Globe, color: '#22c55e' },
  { type: 'cdn', label: 'CDN', icon: CloudCog, color: '#06b6d4' },
